...
namespace JusticeAvengers.Migrations
{
    ...
    [Migration("20241203210425_HeroQuestManyToMany")]
    partial class HeroQuestManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HeroQuest", b =>
                {
                    ...
                    b.HasOne("JusticeAvengers.Models.Quest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JusticeAvengers.Models.Equipment", b =>
                {
                    ...
                    b.HasOne("JusticeAvengers.Models.EquipmentType", "Type")
                        .WithMany()
